                    ...
                    <div class="tab-pane fade in active" id="calendario">
                        ...
                        <div class="rowmargen">
                            ...
                            foreach ($ranking as $rank) {
                                ...
                                echo '<div class="col-md-12 movi-headline-regular cabecera-grupos1 margen5">' . $rank->nombre . '</div>';
                                ?>
                                    ...
                                    <div class="col-md-12 cuerpo">
                                        <div class="row">
                                            <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9  margen5">
                                                    <a href="equipo/<?php echo $rankGroup->equipos_campeonato_id; ?>/<?php echo strtolower($this->partidos->_clearStringGion($rankGroup->name)) ?>" alt="<?php echo $rankGroup->name ?>" title="<?php echo $rankGroup->name ?>">
                                <span
